...
class TestWebsiteCrm(odoo.tests.HttpCase):
    ...
    def test_tour(self):
        self.phantom_js("/", "odoo.__DEBUG__.services['web_tour.tour'].run('website_crm_personalizado_tour')", "odoo.__DEBUG__.services['web_tour.tour'].tours.website_crm_personalizado_tour.ready")
